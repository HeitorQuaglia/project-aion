...
project-aion/
├── docs/
│   └── concept.md        # Design philosophy and system model
├── README.md
```

*This project is in early concept phase. Structure will evolve.*
...
**Roadmap:** See [docs/concept.md](docs/concept.md) for the full system model.
